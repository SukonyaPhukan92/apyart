...
<head>
    ...
    <title>Craft | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Craft</h1>
    <p>A craft is an activity or art such as weaving, carving, or making
something creative which involves a pair of skilled hands ,i.e the hand of the
artists.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Craft' AND ad = 1 order by views DESC");
