...
<head>
    ...
    <title>Quote | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Quote</h1>
    <p>This category is something unique. Here you can upload arts
integrated with quotes or poetry.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Quote' AND ad = 1 order by views DESC");
