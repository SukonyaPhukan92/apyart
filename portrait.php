...
<head>
    ...
    <title>Portait | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Portrait</h1>
    <p>A Portrait is a painting or drawing of a person, especially one
depicting the face or head and shoulders with expressions or emotions.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Portrait' AND ad = 1 order by views DESC");
