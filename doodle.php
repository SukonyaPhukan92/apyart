...
<head>
    ...
    <title>Doodle | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Doodle</h1>
    <p>In this art an artists plays with lines in a sheet with
pens,sketchpens, etc to create a beautiful design.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Doodle' AND ad = 1 order by views DESC");
