...
<head>
    ...
    <title>Abstract | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Abstract</h1>
    <p>Abstract art literally means the distancing of an idea from
objective referents. That means, in the visual arts, pulling a depiction away
from any literal, representational reference points.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Abstract' AND ad = 1 order by views DESC");
