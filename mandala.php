...
<head>
    ...
    <title>Mandala | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Mandala</h1>
    <p>A mandala, which is Sanskrit for “circle” or “discoid object,” is a
geometric design that holds a great deal of symbolism in Hindu and
Buddhist cultures. Here the art is drawn usually in circular form and is
symmetric.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Mandala' AND ad = 1 order by views DESC");
