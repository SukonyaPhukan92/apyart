...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Tech</h1>
    <p>This is the category where it contains art of cars,bikes, gadgets etc everything which  is related to technology.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Tech' AND ad = 1 order by views DESC");
