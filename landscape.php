...
<head>
    ...
    <title>Landscape | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Landscape</h1>
    <p>Landscape is the depiction of natural scenery in art
which may capture mountains, valleys, bodies of water, fields, forests, and
coasts and may or may not include man-made structures as well as people.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Landscape' AND ad = 1 order by views DESC");
