...
<head>
    ...
    <title>Animation | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Animation</h1>
    <p>Animation is that type of art where an artist draws imaginary
visuals or expresses things beautifully in an artistic and creative way such as
cartoons,anime etc.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Animation' AND ad = 1 order by views DESC");
