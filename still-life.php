...
<head>
    ...
    <title>Still Life | ApyArt - Free stock images and illustartion</title>
    <!-- css  -->
...
<?php include "includes/category-menu.php"?>
    ...
    <h1>Still Life</h1>
    <p>A still life is an art or painting that focuses on still objects. The
subject matter that are inanimate and never moves, such as household
objects, flowers, or fruits.</p> 
    </div>
...
$get = mysqli_query($con,"SELECT id, filename, uploader,views FROM artwork WHERE cat = 'Still life' AND ad = 1 order by views DESC");
